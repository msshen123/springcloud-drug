    ...
    (function () {
        ...
        var _getWidgetInfo = function (elementId) {
            ...
            widget.cacheProp = function (prop) {
                ...
                switch (prop) {
                    case 'x':
                        return this.elementAxQuery().locRelativeIgnoreLayer(false);
                    case 'y':
                        return this.elementAxQuery().locRelativeIgnoreLayer(true);
                    case 'pagex':
                        return this.elementAxQuery().left();
                    case 'pagey':
                        return this.elementAxQuery().top();
                }
            ...
            widget.leftfixed = function () {
                this.getFixed('left');
            }
            widget.topfixed = function () {
                this.getFixed('top');
            }
            widget.rightfixed = function () {
                this.getFixed('right');
            }
            widget.bottomfixed = function () {
                this.getFixed('bottom');
            }
